    ...
    <div class="footer__wrapper container">
        ...
        <ul class="footer__social social">
            ...
            <li class="social__item">
                ...
                <svg class="footer__icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0,0,256,256" width="30px"
                    height="30px" fill-rule="nonzero">
                    <g fill="#9eff00" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter"
            ...
            <li class="social__item">
                ...
                <svg class="footer__icon" width="24px" height="24px" version="1.1" xmlns="http://www.w3.org/2000/svg"
